...
func (t *Transaction) GetTransaction() string {
	if t == nil {
		return ""
	}
...
func (t *Transaction) GetInstructions() []*Instruction {
	if t == nil {
		return nil
	}
...
func (t *Transaction) GetLuts() []string {
	if t == nil {
		return nil
	}
	return t.Luts
...
func (t *Transaction) GetSimulationLogs() []string {
	if t == nil {
		return nil
	}
	return t.SimulationLogs
}
