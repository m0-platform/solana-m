...
func (c *Client) Claims(
	...
	pubkey string,
	mint string,
	request *sdkgo.GetClaimsRequest,
	...
	errorCodes := internal.ErrorCodes{
		404: func(apiError *core.APIError) error {
			return &sdkgo.InvalidMint{
				APIError: apiError,
			}
		},
	}

	var response *sdkgo.Claims
...
func (c *Client) Transfers(
	...
	pubkey string,
	mint string,
	request *sdkgo.BalanceUpdatesRequest,
	opts ...option.RequestOption,
) (*sdkgo.BalanceUpdates, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *sdkgo.BalanceUpdates
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
